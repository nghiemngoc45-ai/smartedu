...
5. **Quản trị viên hệ thống (Admin)** — vận hành sàn.
6. **Người bán / Nhà cung cấp** — *hiện gộp trong Admin, chưa tách cổng riêng.*
...
| Tính năng | Khách | Bạn đọc | Giáo viên | Trường học | Admin |
|---|:--:|:--:|:--:|:--:|:--:|
